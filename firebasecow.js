...
const firebaseConfig = {
  apiKey: "AIzaSyByguH2isQmfrnpPHkrDC6R2T4EhQvkhFQ",
  authDomain: "cow-dairy-data.firebaseapp.com",
  projectId: "cow-dairy-data",
  storageBucket: "cow-dairy-data.firebasestorage.app",
  messagingSenderId: "296089436052",
  appId: "1:296089436052:web:f7d569e8b1afa9f98d9981",
  measurementId: "G-DC2E8KCKES"
};
...
async function fetchSavedData() {
    ...
    const farmerRef = doc(collection(db, "cow-milk-data"), farmerName);
    const dateRef = doc(collection(farmerRef, "date"), billDate);
